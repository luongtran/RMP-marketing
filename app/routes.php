...
Route::post( 'contact-sendmail' , array('as' => 'send_email_contact', 'uses' => 'SharedController@sendContact'));
...
//test feature
Route::get('features',array('as' => 'view_page_feature', 'uses' =>'HomeController@feature'));
