...
@section('breadcrumb')      
 <ul id="breadcrumb">
                ...
                <li><a href="{{Request::root()}}/backend/module/{{$infoMod->id}}/content" title="Sample page 1">Intro [ Module {{$infoMod->name}} ]</a>
                </li>
                 <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
...
<div class="content-wrap">
                <div class="row">                   
                  {{Form::open(array('url'=>'backend/module/'.$infoMod->id.'/intro/update/'.$module_data->id, 'method' => 'post','role'=>'form','enctype'=>'multipart/form-data','id'=>'frm-setting') )}}                                                                                                            
                    <div class="col-sm-8"> 
